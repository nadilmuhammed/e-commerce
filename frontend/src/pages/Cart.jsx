        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-slate-900/20 text-gray-30 regular-14 xs:regular-16 text-start py-12">
              <th className="pl-1 text-left">Product</th>
              <th className="pl-1 text-left">Title</th>
              <th className="pl-1 text-left">Price</th>
              <th className="pl-1 text-left">Quantity</th>
              <th className="pl-1 text-left">Total</th>
              <th className="pl-1 text-left">Remove</th>
            </tr>
          </thead>
          <tbody>
            {all_products.map((product) => {
              if (cartItems[product._id] > 0) {
                return (
                  <tr
                    key={product._id}
                    className="border border-slate-900/20 text-gray-50 p-6 medium-14 text-left"
                  >
                    <td className="p-1">
                      <img
